...
`
            ...
            blackoutEffectInterval = setInterval(function() {
        ...
        a.drawGrads(a.canvasAPI, {
            ...
            sprites: [{
                ...
                },
                {
                    ...
                    size: [42, 255],
                    center: [0, 0],
                    value: geofs.animation.values.haglFeet
                },
            ],
        });
        d.restore();
  ...
  if (enabled.visuals) {
    function checkNightStuff() {
        ...
        if (geofs.camera.currentModeName == "cockpit" && geofs.isNight == 1 && geofs.api.renderingSettings.advancedAtmosphere == 0) {
            ...
            geofs.api.viewer.scene.light.color = {
                red: 0.8,
                green: 0.63,
                blue: 0.52,
                alpha: 1
    ...
    //no need to touch any of this bc it isn't visible
